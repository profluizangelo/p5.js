/* criando o ambiente no sketch: inimigos, temporizador/contador, pontos */
let enemies = [];
let timer = 1;
let points = 0;

/* definindo cenário/ambiente */
function setup() {
...
/* jogo on line gerado via https://editor.p5js.org/ */
